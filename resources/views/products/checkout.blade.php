        ...
        <div class="checkout-form-section">
            ...
            <div class="form-card">
                <form action="{{ route('order.store') }}" method="POST" id="checkout-form" novalidate>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="notes">Ghi chú đơn hàng (Tùy chọn)</label>
                        <textarea name="notes" id="notes" class="form-textarea" placeholder="Ghi chú về thời gian giao hàng, chỉ dẫn địa chỉ..."></textarea>
                    </div>
        ...
        <div class="checkout-summary-section">
            ...
            <div class="summary-card-sticky">
                <div style="max-height: 350px; overflow-y: auto; padding-right: 5px;">
                    <div class="order-item">
                        @if(!empty($product->image))
                            <img src="/{{ ltrim($product->image, '/') }}" class="order-item-img" alt="{{ $product->name }}">
                        @else
                        ...
                        <div class="order-item-info">
                            ...
                            <div class="order-item-meta">Số lượng: 1</div>
                        </div>
                        <div class="order-item-price">{{ number_format($product->price) }}đ</div>
                    </div>
                </div>
                ...
                <div style="margin-top: 20px; text-align: center;">
                    <a href="{{ route('product.show', $product->slug) }}" style="color: var(--text-muted); text-decoration: none; font-size: 14px; font-weight: 600;">
                        <i class="fa-solid fa-arrow-left"></i> Quay lại chi tiết sản phẩm
                    </a>
                </div>
            </div>
        </div>
            ...
            <div>
                ...
                <div style="max-height: 200px; overflow-y: auto; border: 1px solid #e5e7eb; padding: 12px; display: flex; flex-direction: column; gap: 12px; background: #fafafa;">
                    <div style="display: flex; gap: 12px; align-items: center;">
                        @if(!empty($product->image))
                            <img src="/{{ ltrim($product->image, '/') }}" style="width: 45px; height: 45px; object-fit: cover; border: 1px solid #e5e7eb; border-radius: 4px;" alt="{{ $product->name }}">
                        @else
                        ...
                        <div style="flex: 1; min-width: 0;">
                            ...
                            <div style="font-size: 12px; color: #6b7280;">Số lượng: 1</div>
                        </div>
                        <div style="font-size: 13px; font-weight: 700; color: #1f2937;">{{ number_format($product->price) }}đ</div>
                    </div>
                </div>
            </div>
